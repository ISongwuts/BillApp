...
static PyObject *impl_pywin$mfc$window$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_534457ecb414dc7d3c83ddce7f4fd3bb = MAKE_FUNCTION_FRAME(codeobj_534457ecb414dc7d3c83ddce7f4fd3bb, module_pywin$mfc$window, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_534457ecb414dc7d3c83ddce7f4fd3bb);
...
static PyObject *impl_pywin$mfc$window$$$function__3___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_bd5b501ab012d43b803b2bfe5f580742)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_bd5b501ab012d43b803b2bfe5f580742 = MAKE_FUNCTION_FRAME(codeobj_bd5b501ab012d43b803b2bfe5f580742, module_pywin$mfc$window, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_bd5b501ab012d43b803b2bfe5f580742);
...
static PyObject *impl_pywin$mfc$window$$$function__4___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2f7df156742d794ad6b8cf1e46b5b5c8)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2f7df156742d794ad6b8cf1e46b5b5c8 = MAKE_FUNCTION_FRAME(codeobj_2f7df156742d794ad6b8cf1e46b5b5c8, module_pywin$mfc$window, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2f7df156742d794ad6b8cf1e46b5b5c8);
...
static PyObject *impl_pywin$mfc$window$$$function__5_OnCreateClient(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_ee0a0bb334bb59c5fd8c265b172cf29a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_ee0a0bb334bb59c5fd8c265b172cf29a = MAKE_FUNCTION_FRAME(codeobj_ee0a0bb334bb59c5fd8c265b172cf29a, module_pywin$mfc$window, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_ee0a0bb334bb59c5fd8c265b172cf29a);
...
static PyObject *impl_pywin$mfc$window$$$function__6___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_ab14a94d146931cb866f5918ab9f0474)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_ab14a94d146931cb866f5918ab9f0474 = MAKE_FUNCTION_FRAME(codeobj_ab14a94d146931cb866f5918ab9f0474, module_pywin$mfc$window, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_ab14a94d146931cb866f5918ab9f0474);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_612f2f3e64d57bb3b02d9eefe9d54785);
    ...
    branch_end_1:;
    {
        ...
        frame_eb06da1c019a0e2c2dd4f49afce60881_2 = MAKE_CLASS_FRAME(codeobj_eb06da1c019a0e2c2dd4f49afce60881, module_pywin$mfc$window, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_eb06da1c019a0e2c2dd4f49afce60881_2);
    ...
    branch_yes_5:;
    {
        ...
        tmp_mod_expr_right_2 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_7 = LOOKUP_ATTRIBUTE(tmp_expression_value_11, mod_consts[29]);
    ...
    branch_end_4:;
    {
        ...
        frame_f6ac1139c69521bfd0154e5ddfb3d737_3 = MAKE_CLASS_FRAME(codeobj_f6ac1139c69521bfd0154e5ddfb3d737, module_pywin$mfc$window, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_f6ac1139c69521bfd0154e5ddfb3d737_3);
    ...
    branch_yes_8:;
    {
        ...
        tmp_mod_expr_right_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_11 = LOOKUP_ATTRIBUTE(tmp_expression_value_16, mod_consts[29]);
    ...
    branch_end_7:;
    {
        ...
        frame_ab5a2c3f6cb0d7a93bb8c949e6a4e2ac_4 = MAKE_CLASS_FRAME(codeobj_ab5a2c3f6cb0d7a93bb8c949e6a4e2ac, module_pywin$mfc$window, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_ab5a2c3f6cb0d7a93bb8c949e6a4e2ac_4);
    ...
    branch_yes_11:;
    {
        ...
        tmp_mod_expr_right_4 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_15 = LOOKUP_ATTRIBUTE(tmp_expression_value_21, mod_consts[29]);
    ...
    branch_end_10:;
    {
        ...
        frame_035aa409b5bccc0a0b729e7957360fb4_5 = MAKE_CLASS_FRAME(codeobj_035aa409b5bccc0a0b729e7957360fb4, module_pywin$mfc$window, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_035aa409b5bccc0a0b729e7957360fb4_5);
