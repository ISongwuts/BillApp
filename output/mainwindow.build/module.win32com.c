...
static PyObject *impl_win32com$$$function__1_SetupEnvironment(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_86feb4eb9ec3e807225e0839643d4dd1 = MAKE_FUNCTION_FRAME(codeobj_86feb4eb9ec3e807225e0839643d4dd1, module_win32com, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_86feb4eb9ec3e807225e0839643d4dd1);
    ...
    // Tried code:
    {
        ...
        tmp_add_expr_left_1 = LOOKUP_SUBSCRIPT_CONST(tmp_expression_value_7, tmp_subscript_value_1, 0);
    ...
    // Tried code:
    {
        ...
        tmp_cmp_expr_right_6 = LOOKUP_ATTRIBUTE(tmp_expression_value_11, mod_consts[8]);
    ...
    // Tried code:
    {
        ...
        tmp_cmp_expr_right_8 = LOOKUP_ATTRIBUTE(tmp_expression_value_13, mod_consts[8]);
...
static PyObject *impl_win32com$$$function__2___PackageSupportBuildPath__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_7c5cbcfe894a157baeb77e4c7c5fa2c3)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_7c5cbcfe894a157baeb77e4c7c5fa2c3 = MAKE_FUNCTION_FRAME(codeobj_7c5cbcfe894a157baeb77e4c7c5fa2c3, module_win32com, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_7c5cbcfe894a157baeb77e4c7c5fa2c3);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_d31089ad139d48b400e7a7d8e6b99590);
